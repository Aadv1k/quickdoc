...
int main(int argc, char **argv) {
  ...
  memcpy(grayscaleData, data, width * height);
  ...
  size_t rightEdge = cv_get_left_edge(grayscaleData, width, height, channels, leftEdge);
  printf("%llu %llu %llu\n", leftEdge, rightEdge, (size_t)width);
  width = cv_crop_x_edge_grayscale_and_get_width(grayscaleData, width, height, channels, leftEdge, width - rightEdge);
  //width = cv_crop_x_edge_grayscale_and_get_width(grayscaleData, width, height, channels, 0, rightEdge);
